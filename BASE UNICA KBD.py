...
df_Leads_MKT = pd.read_excel(ruta_Leads_MKT, engine='openpyxl', usecols=['Correo', 'Nombre', 'Fecha-MKT', 'Campaña', 'Procedencia', 'Estado', 'Celular', 'Especialidad'])
df_CP = pd.read_excel(ruta_CP, engine='openpyxl', usecols=['FOLIO', 'Cliente potencial', 'ULTIMO CONTACTO', 'CORREO', 'CELULAR', 'ESPECIALIDAD', 'CANAL DE PROCEDENCIA', 'EVENTO/CAMPAÑA', 'ZONA', 'ESTADO', 'CIUDAD', 'ASESOR1', 'CREADO-CP'])
...
columnas_leads_mkt = ['Correo', 'Nombre', 'Fecha-MKT', 'Campaña', 'Procedencia', 'Estado', 'Celular', 'Especialidad']
columnas_CP = ['FOLIO', 'Cliente potencial', 'ULTIMO CONTACTO', 'CORREO', 'CELULAR', 'ESPECIALIDAD', 'CANAL DE PROCEDENCIA', 'EVENTO/CAMPAÑA', 'ZONA', 'ESTADO', 'CIUDAD', 'ASESOR1', 'CREADO-CP']
...
df_todos_correos.to_excel(ruta_resultado_cp, sheet_name='Sheet1', index=False, engine='openpyxl')
...
with pd.ExcelWriter(ruta_resultado_cp, mode='a', engine='openpyxl') as writer:
