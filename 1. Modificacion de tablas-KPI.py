...
columnas_a_pivotar = [
    'FRECUENCIA', 'FOLIO',	'ESTATUS',	'NOMBRE',	'FECHA DE CONTACTO',	'COICIDENCIA CLIENTE POTENCIAL',	'LEAD ASOCIADO',
    'ZONA',	'CELULAR',	'CORREO',	'CANAL DE PROCEDENCIA',	'TIPO DE CAMPAÑA',	'ORIGEN PROSPECTO',	'ASESOR',	'CLIENTE POTENCIAL',
    'FECHA DE ASIGNACIÓN',	'OPORTUNIDADES',	'ESPECIALIDAD',	'CIUDAD',	'ESTADO',	'CAMPAÑA',	'COMENTARIOS',	'FECHA DE CREACIÓn',
    'ULTIMO CONTACTO'
]
